...
const images = [
  ...
  require("../../../assets/images/resources/Take_Care_of_Your_Mind/2.png"),
  require("../../../assets/images/resources/Take_Care_of_Your_Mind/3.png"),
];

export default function MentalHealthSlider() {
