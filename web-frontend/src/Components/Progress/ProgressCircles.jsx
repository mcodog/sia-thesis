...
const ProgressCircles = ({ scrollY, totalScrollHeight, numCircles }) => {
  ...
  return (
    <div className="absolute pt-20 top-0 h-full w-10 flex justify-center items-center">
      <div className="h-1/4 w-20 bg-white shadow-custom rounded-lg flex flex-col p-3 gap-2">
