  ...
  return (
    <Box p={4} sx={{ backgroundColor: "#e8f5e9", minHeight: "100vh" }}>
      <Box display="flex" justifyContent="space-between" mb={3}>
        ...
        <Box>
          <Button variant="contained" sx={{ backgroundColor: "#4caf50", color: "white", mr: 2 }} startIcon={<PrintIcon />} onClick={handlePrint}>
            Print Report
          </Button>
          <Button variant="contained" sx={{ backgroundColor: "#388e3c", color: "white" }} startIcon={<PictureAsPdfIcon />} onClick={handlePrint}>
            Save as PDF
          </Button>
        </Box>
      </Box>
      <div ref={printRef}>
        ...
        <Paper sx={{ p: 3, mb: 4, backgroundColor: "#a5d6a7" }}>
          ...
          <DataGrid rows={userData} columns={userColumns} pageSize={5} disableSelectionOnClick autoHeight />
        </Paper>
        ...
        <Paper sx={{ p: 3, backgroundColor: "#81c784" }}>
          ...
          <DataGrid rows={counselingData} columns={getCounselingColumns()} pageSize={10} disableSelectionOnClick autoHeight />
        </Paper>
      </div>
    </Box>
  );
