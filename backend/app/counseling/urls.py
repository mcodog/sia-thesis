...
from .views import (
    ...
    AllMoodEntriesView, AllDiariesView, AllUserProfilesView, ChatLogViewSet, CallRecordViewSet
...
router.register(r'AdminChat', ChatLogViewSet, basename='admin-chatlogs')
